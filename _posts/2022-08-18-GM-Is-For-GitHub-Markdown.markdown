...
This is intended as a quick reference and showcase. For more complete info, see John Gruber's 
http://daringfireball.net/projects/markdown/
original spec and the Github-flavored Markdown info page.
http://daringfireball.net/projects/markdown/

Note that there is also a Cheatsheet specific to Markdown Here 
https://github.com/adam-p/markdown-here/wiki/Markdown-Here-Cheatsheet
if that's what you're looking for. You can also check out more Markdown tools.
